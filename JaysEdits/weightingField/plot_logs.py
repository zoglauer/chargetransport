...
phi_paths = glob.glob('/home/jgarg20/chargetransport/CorysCode/weightingField/logs' + '/phi_*')
...
phires_paths = glob.glob('/home/jgarg20/chargetransport/CorysCode/weightingField/logs' + '/phiFinalRes_*')
...
#print(phi_paths, phires_paths)
#print(phi[:10], phi_res[:10])
